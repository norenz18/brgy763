                                    ...
                                    <tbody id="tbody">
                                        <?php foreach($result as $setrows) : ?>  
                                            <tr>
                                                ...
                                                <a class="btn btn-secondary btn-sm" id="Indigency" data-toggle="tooltip" target="__blank"  title="View Indigency" href="<?php echo site_url('CertificateController/indigencyPdf'); ?>/<?php echo $setrows->id; ?>"><i class="fas fa-print"> Indigency</i></a>
                                                <a class="btn btn-primary btn-sm" id="Clearance" data-toggle="tooltip" target="__blank"  title="View Clearance" href="<?php echo site_url('CertificateController/clearancePdf'); ?>/<?php echo $setrows->id; ?>"><i class="fas fa-print"> Clearance</i></a>
                                                <a class="btn btn-success btn-sm" id="Business-Permit" data-toggle="tooltip" target="__blank"  title="View Business Permit" href="<?php echo site_url('CertificateController/businessPdf'); ?>/<?php echo $setrows->id; ?>"><i class="fas fa-print"> Business</i></a>
